# Evaluación sobre el Delegado de Protección de Datos (DPD/DPO) — Redinmo.io

> Documento interno, no público (fase de cierre, punto 2.4). El objetivo no
> es concluir con certeza legal si Redinmo.io necesita un DPO — eso lo decide
...
## Situación actual de Redinmo.io frente a estos criterios
...
- **Actividad principal**: la actividad principal de Redinmo.io es la intermediación inmobiliaria entre agentes, no el tratamiento de datos en sí mismo (a diferencia de, por ejemplo, un data broker o una empresa de scoring crediticio).
...
Con el volumen y la naturaleza de datos actuales, Redinmo.io **probablemente no está obligado** a designar un Delegado de Protección de Datos. Ninguno de los criterios de "gran escala" o "categorías especiales" parece cumplirse hoy.
...
- Redinmo.io empieza a tratar datos de una categoría especial (por ejemplo, si se agregara verificación biométrica de identidad).
- Redinmo.io cambia de modelo de negocio hacia algo cuya actividad principal sea el tratamiento o la venta de datos.
