...
import { IconClipboard, IconContract, IconGlobe, IconGrid, IconHouse, IconInvite, IconLetter, IconMapPin, IconPodium, IconStar, IconSubscription, IconUser } from './icons';
...
const AGENT_TABS: DashboardTab[] = ['invitar', 'resumen', 'ranking', 'misitio', 'cartas', 'contratos', 'inmuebles', 'pedidos', 'matches', 'cierres'];
