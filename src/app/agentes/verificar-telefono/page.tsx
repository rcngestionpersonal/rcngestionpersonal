      ...
      <div className="mx-auto max-w-md">
        ...
        <section className="glass-card rounded-3xl p-5 sm:p-6">
          <p className="text-sm text-white/70">
            Teléfono: <span className="font-semibold text-white">{agent.phone}</span>
          </p>

          <button
            onClick={requestCode}
            disabled={requesting}
            className="gradient-btn mt-4 w-full rounded-xl px-4 py-3 text-sm font-semibold text-white disabled:cursor-not-allowed disabled:opacity-60"
          >
          ...
          <div className="mt-3 flex flex-col gap-2 sm:flex-row">
            <input
              className="flex-1 rounded-xl border border-white/15 bg-white/5 px-3 py-2.5 text-sm text-white outline-none placeholder:text-white/35 focus:border-violet-400"
              value={code}
            ...
            <button
              ...
              className="rounded-xl bg-gradient-to-br from-[#8b5cf6] to-[#6d28d9] px-4 py-2.5 text-sm font-semibold text-white transition-transform duration-200 hover:scale-[1.02] disabled:cursor-not-allowed disabled:opacity-60"
            >
